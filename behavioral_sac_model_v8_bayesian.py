"""
behavioral_sac_model_v6_hybrid_core.py

Clean v6 hybrid SAC portfolio model.
...
TOP20_TICKERS = [
    # Core Top-20 stocks used in earlier experiments
    ...
    # Sector + defensive / stress-rotation ETFs
    "XLK", "XLF", "XLE", "XLV", "XLP", "XLU",
    "TLT", "IEF", "GLD", "SHY",
]
...
class ModelConfig:
    ...
    period: str = "730d"
    interval: str = "1h"
    universe_name: str = "v6_hybrid_core_stochastic_etfs"
    bottom_k: int = 5
...
def main() -> None:
    ...
    model = SAC(
        ...
        ent_coef=cfg.ent_coef,batch_size=cfg.batch_size,
        gamma=cfg.gamma,
        tau=cfg.tau,
        seed=cfg.seed,
        verbose=1,
    ...
    for row in results:
        print(row)
    summary_path = os.path.join(RESULTS_DIR, "summary_results_v6_hybrid_core.json")
    with open(summary_path, "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2)
    print("[saved] summary ->", summary_path)

    print("\n=== Exporting one human-readable replay ===")
    replay_path = os.path.join(RESULTS_DIR, "top20_episode_log_v6_hybrid_core.json")
