...
How to use:
    ...
    Run in Colab:
        ...
        !python v6_experiments/v6_exp_fixed_entropy.py
...
def main():
    ...
    text = patch_results_name(text, "v6_fixed_entropy")

    # Replace auto entropy with fixed entropy to avoid entropy collapse.
    text = re.sub(r'ent_coef\s*=\s*["\']auto["\']', 'ent_coef=0.005', text)
    text = re.sub(r'ent_coef\s*=\s*["\']auto_[^"\']*["\']', 'ent_coef=0.005', text)

    run_patched(text, "_tmp_v6_fixed_entropy.py")
