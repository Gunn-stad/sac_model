"""
v6_exp_short_training_40000.py
...
How to use:
    ...
    Run in Colab:
        ...
        !python v6_experiments/v6_exp_short_training_40000.py
...
def main():
    ...
    text = patch_results_name(text, "v6_short_training_40000")
    ...
    for pat, rep in replacements:
        ...
        if new != text:
            ...
            break
    if not patched:
        print("[warning] could not find timestep pattern; running base unchanged.")

    run_patched(text, "_tmp_v6_short_training_40000.py")
